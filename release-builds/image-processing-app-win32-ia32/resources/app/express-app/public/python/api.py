...
defaultImagePath = "./resources/app/express-app/public/python/images/"
...
def getImageParameters(filename, save_source=True, defaultImagePath= "./resources/app/express-app/public/python/images/"):
    ...
    with open('./resources/app/express-app/public/python/data/data_color.json', 'w+') as fp:
...
def removeFiles():   
    ...
    """
    folder = "./resources/app/express-app/public/python/images"
